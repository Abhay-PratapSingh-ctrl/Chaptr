    ...
    getScriptSrc = () => {
      ...
      if (true) {
        if (isEsmImportMetaUrlHardcodedAsFileUri) {
          const URL2 = URL;
          return new URL(new URL2("ort.wasm.mjs", ({url:"file:///"}).url).href, origin).href;
        }
        return ({url:"file:///"}).url;
      }
            ...
            try {
              ...
              if (false) {
                message.in.wasm.wasmPaths = {
                  wasm: false ? new URL("ort-wasm-simd-threaded.jsep.wasm", ({url:"file:///"}).url).href : false ? new URL("ort-wasm-simd-threaded.jspi.wasm", ({url:"file:///"}).url).href : false ? new URL("ort-wasm-simd-threaded.asyncify.wasm", ({url:"file:///"}).url).href : new URL("ort-wasm-simd-threaded.wasm", ({url:"file:///"}).url).href
                };
              }
