...
var init_wasm_utils_import = __esm({
  "web/lib/wasm/wasm-utils-import.ts"() {
    ...
    isEsmImportMetaUrlHardcodedAsFileUri = ({url:"file:///"}).url > "file:" && ({url:"file:///"}).url < "file;";
    getScriptSrc = () => {
      if (isNode) {
        return void 0;
      }
      if (true) {
        if (isEsmImportMetaUrlHardcodedAsFileUri) {
          const URL2 = URL;
          return new URL(new URL2("ort.webgpu.mjs", ({url:"file:///"}).url).href, origin).href;
        }
        return ({url:"file:///"}).url;
      }
            ...
            try {
              ...
              if (false) {
                message.in.wasm.wasmPaths = {
                  wasm: false ? new URL("ort-wasm-simd-threaded.jsep.wasm", ({url:"file:///"}).url).href : false ? new URL("ort-wasm-simd-threaded.jspi.wasm", ({url:"file:///"}).url).href : true ? new URL("ort-wasm-simd-threaded.asyncify.wasm", ({url:"file:///"}).url).href : new URL("ort-wasm-simd-threaded.wasm", ({url:"file:///"}).url).href
                };
              }
